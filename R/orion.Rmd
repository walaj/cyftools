...
if (FALSE) {
  ...
  nn <- c("tumor"="-A 1", "stroma"="-N 1","all"="", "scramble_tumor"="-A 1", "scramble_stroma"="-N 1","tumor_margin"="-A 5","stroma_margin"="-A 4 -N 1","margin"="-A 4","tumor_core"="-A 1 -N 4","stroma_core"="-N 5","tumor_manual"="-A 8",
          "tumor_manual_panck"="-A 8 -a 131072")
  ...
  lapply(seq_along(nn)[11], function(n) {
    dtt <- lapply(files[1:5], function(f) {
      ...
      drr = fread(cmd=paste("cysift cellcount", tmpfile," - -a 133120 -a 10240 -a 36864 -a 32832 -a 0 -a 135168 | cysift view - -R"))
...
hard_coded_tip_combo_50r_manual <- c("LSP14418","LSP14388","LSP14438","LSP15308","LSP10388","LSP10584","LSP14363","LSP14448") 
